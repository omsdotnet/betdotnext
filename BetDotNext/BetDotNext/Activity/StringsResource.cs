namespace BetDotNext.Activity
{
  public static class StringsResource
  {
    public static string StartActivityMessage = "Здравия желаю!\r\n" + 
                                                ...
                                                "Спикеры: https://dotnext-moscow.ru/faces/ \r\n" +
                                                ...
                                                "количество баллов поставленных на первое место - утраивается\r\n" +
                                                "количество баллов поставленных на определенные места (2-10) - упятеряется\r\n" +
                                                "\r\n" +
